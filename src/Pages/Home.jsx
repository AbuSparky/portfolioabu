...
import resume from "../assets/Nihamathullah-- s.pdf";
...
const Home = () => {
  const handleDownload = () => {
    ...
    link.href = pdfUrl;
    link.download = "Nihamathullah--s.pdf"; // specify the filename
      ...
      >
        ...
        >
          <Text
            ...
            color="brand.white"
          >
            Hello, I&apos;m <span style={{ color: "#33FFCC" }}>Nihamath!</span>
          </Text>
        </motion.div>
          ...
          <Flex gap={{ md: 6, base: 3 }}>
            ...
            <Flex gap={{ md: 5, base: 3 }}>
              ...
              <Flex
                ...
                borderColor={"brand.buttonGreen"}
                onClick={() => {
                  window.location.href = "https://github.com/AbuSparky";
                }}
                cursor={"pointer"}
              >
